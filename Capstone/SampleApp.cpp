...
bool SampleApp::frameRenderingQueued(const Ogre::FrameEvent& evt)
{
	...
	//	}
	//}
	mCharacterBody->setAngularFactor(btVector3(1,0,0));
	mCharacterBody->setLinearFactor(btVector3(1,1,0));

	mImpulse = btVector3(0,0,0);
	if(mKeyboard->isKeyDown(OIS::KC_D))
	{
		mCharacterBody->applyImpulse(btVector3(0.5,0,0),btVector3());
	}
	...
	{
		mCharacterBody->applyImpulse(btVector3(0,1,0),btVector3());
	}
	if(mKeyboard->isKeyDown(OIS::KC_S))
	{
		mCharacterBody->applyImpulse(btVector3(0,-0.5,0),btVector3());
	}
